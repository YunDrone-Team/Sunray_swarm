...
class orca_cmd {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('orca_cmd')) {
        this.orca_cmd = initObj.orca_cmd
      }
      else {
        this.orca_cmd = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [orca_cmd]
    bufferOffset = _serializer.uint8(obj.orca_cmd, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new orca_cmd(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [orca_cmd]
    data.orca_cmd = _deserializer.uint8(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new orca_cmd(null);
    ...
    if (msg.orca_cmd !== undefined) {
      resolved.orca_cmd = msg.orca_cmd;
    }
    else {
      resolved.orca_cmd = 0
    }
